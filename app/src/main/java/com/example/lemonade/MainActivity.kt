...
class MainActivity : AppCompatActivity() {
    ...
    private fun setViewElements() {
        ...
        when (lemonadeState){
            ...
            getString(R.string.select).also { textAction.text = it }
            }
            SQUEEZE-> {
                lemonImage?.setImageResource(R.drawable.lemon_squeeze)
                getString(R.string.Squeeze).also { textAction.text= it }
            }
            DRINK->{
                lemonImage?.setImageResource(R.drawable.lemon_drink)
                getString(R.string.Drink_string).also{textAction.text=it}
            }
            RESTART->{
                lemonImage?.setImageResource(R.drawable.lemon_restart)
                textAction.setText(R.string.Restart_String)
